...
%   'path'      returns the path (fn_fileparts('a/b/','path') returns 'a')
%   'base'      removes the path and the extension (fn_filename('a/b.c','base')
%               returns 'b') 
%   'ext'       returns the extension (fn_fileparts('a/b.c','ext') returns '.c')
%   'extnodot'  returns the extension without dot (fn_filename('a/b.c','extnodot') returns 'c')
%   'name'      removes the path (fn_fileparts('a/b/','name') returns 'b',
%               fn_fileparts('a/b.c','name') returns 'b.c') 
%   'noext'     removes the extention (fn_fileparts('a/b.c','noext') returns
%               'a/b') 
